...
namespace Tigren\Testimonial\Controller;

use Tigren\Testimonial\Service\PostIdChecker;
...
class Router implements RouterInterface
{
    ...
    public function match(RequestInterface $request)
    {
        ...
        if (!empty($parts[0]) && 'testimonial' === $parts[0] && !empty($parts[1])) {
            $urlKey = $parts[1];
        } else {
            return null;
        }
